...
- main は T14.33 の結果 (`feccb26`) 以降に T14.32 / T14.27 も入って **33 / 60 完了** (T14.0〜8, 10〜27, 29〜33, 35〜37)。**未 push**。
...
- **途中で止めた枝 (worktree は `../rust-http-proxy-wt/<名前>` に残してある。`wip:` のコミットが最新)**:
...
- [ ] **T14.31 直近の窓の正確な分位点 (標本を 1,024 本そのまま持つ)**
...
- [ ] **T14.34 日次の自動 `/snapshot` 保存 (`$HOME/.rust-http-proxy/snapshots/`、30 日ぶん)**
