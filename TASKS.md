...
- [ ] **T14.3 締める (README と §2 と §0 をデプロイ先の数字で書き直す)**
  ...
  - やること: T14.1 を再デプロイして 24 時間の数字が出てから。README の性能節に「デプロイ先 (実際の利用) の数字」の表を足す:
    CONNECT 確立 p50 / p95、名前解決ミス率、RSS、`GET /`、個票のエンドポイント。§0 に「デプロイ先: 2026-09-XX、CONNECT 確立 p50 N ms
