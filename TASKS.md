...
| ビルドが通る最小のメモリ | 347 MB でも通らない | **110 MB** (手元、T10.0。T9.0 では 100 MB だった) / 110 MB (CI、T7.4) — 上限 200 MB | fat LTO なので 350 MB 要る (T9.1、配布は潤沢な環境で作る) |
| バイナリ | 857 KB | 1,381,872 B | **988,648 B** |
| テスト | 150 単体 + 21 結合 | **189 単体 + 48 結合** (T9.6 時点。T10.0 では走らせていない) | — |
