...
**順番 (2026-09-16 に入れ替えた)**: **T14.1 → T14.2 → T14.3 → T14.4 → (T14.5 ∥ T14.7) → T14.6 → T14.8 → [T14.9 → T14.12 → T14.11 → T14.10、T14.15 → T14.18 → T14.17 → T14.14 → T14.16 → T14.20 → T14.19 → T14.21、T14.22 → T14.23 → T14.28 のうち
再デプロイ前に間に合った分] → 再デプロイ → 24 時間 → T14.99** (T14.24〜T14.27、T14.29、T14.30 は再デプロイ後でもよい) (T14.4 は個票の形を決めるので先、T14.5 と T14.7 は触るファイルが違うので並列、
