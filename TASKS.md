...
再デプロイ前に間に合った分] → **今日の締め T14.55 → T14.56 → T14.57 → T14.58** → push → 再デプロイ → 24 時間 → T14.99** (T14.24〜T14.27、T14.29、T14.30、T14.32、T14.33、T14.35〜T14.46、T14.48〜T14.54 は再デプロイ後でもよい。T14.41 (記録の一括 off とハッシュ化) だけは
...
- [ ] **T14.18 公開プロキシとしての止め方 (`PROXY_ENDPOINTS_READONLY`、`PROXY_ALLOW_CLIENTS`。既定は無効で入れる — 2026-09-16 の指示)**
