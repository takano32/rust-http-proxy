...
| CONNECT トンネル 1 本 | 1,044 MiB/s | 1,268 MiB/s (固定しなければ 2,243) | 1,227 MiB/s (同 2,160) |
...
| トンネル 1 本 | 1,268 MiB/s | 2,243 MiB/s |
...
- [x] トンネルが 1.5 GiB/s 以上 — 固定なしで **2.2 GiB/s** (固定ありは 1.24 GiB/s。この経路はベンチが律速する)
...
- [ ] **T10.8 `--only tunnel` はプロキシではなくベンチを測っている**
